                ...
                while($row=mysqli_fetch_assoc($result))
                    {
                        ...
                        echo"
                        <td class='nazev'><a href='produkt.php?id=".$row["ID"]."'>".$row["Název"]."</a></td>
                        ...
                        echo"
                        <td class='cena'>".$row["Cena"]." Kč</td>
                        <td class='cena'>".$row["Cena s DPH"]. " Kč</td>
                        <td class='dph'>".$row["DPH"]." %</td>";
