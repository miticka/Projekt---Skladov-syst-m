...
$_SESSION["action"]="prijem";
?>

        <section class="mainpage">
            <div class="prijem"><h1>Příjem zboží</h1></div>
            <div class="top">
               <div>
                    <form method="get" action="prijem.php">
                ...
                while($row=mysqli_fetch_assoc($result))
                    {
                        ...
                        echo"
                        <td>
                            <form method='post' action='prijem_update.php' class='prijem_update'>
